...
export default function ProductsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Управление позициями, ценами закупки/продажи и штрихкодами
          </p>
        </div>
      ...
      {/* Filters Bar */}
      <div className="flex flex-col md:flex-row items-center gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <select
            ...
            className="rounded-xl border border-slate-200 bg-slate-50 py-2 px-3 text-sm text-slate-700 outline-none focus:border-blue-500"
          >
          ...
          <table className="w-full text-left text-sm">
            <thead className="border-b border-slate-200 bg-slate-50/50 text-xs uppercase text-slate-400 font-semibold">
              <tr>
                ...
                <th className="py-3.5 px-4">Штрихкод / Артикул</th>
                <th className="py-3.5 px-4">Категория</th>
                <th className="py-3.5 px-4 text-right">Закупка</th>
                <th className="py-3.5 px-4 text-right">Продажа</th>
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-slate-400">Ед: {p.unit}</div>
                          </div>
                        </div>
                      </td>
                      <td className="py-3 px-4">
          ...
          <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-2xl overflow-y-auto max-h-[90vh]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="Например: Шоколад молочный 90г"
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 px-3.5 text-sm font-medium outline-none focus:border-blue-500 focus:bg-white"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 px-3.5 font-mono text-sm font-semibold outline-none focus:border-blue-500 focus:bg-white"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="SNK-001"
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 px-3.5 text-sm font-semibold outline-none focus:border-blue-500 focus:bg-white"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 px-3.5 text-sm font-semibold text-blue-600 outline-none focus:border-blue-500 focus:bg-white"
                  />
                </div>

                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wider text-slate-600 mb-1">
                    Количество остатка ({formData.unit})
                  </label>
                  <input
                    type="number"
                    step="0.1"
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="flex items-center gap-4">
                    {formData.imageUrl ? (
                      ...
                      <label className="flex h-16 w-32 cursor-pointer items-center justify-center gap-2 rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 hover:bg-slate-100 transition">
                    ...
                    <input
                      ...
                      className="flex-1 rounded-xl border border-slate-200 bg-slate-50 py-2.5 px-3.5 text-xs outline-none focus:border-blue-500 focus:bg-white"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 flex items-center justify-end gap-3 border-t border-slate-100 pt-4">
                ...
                >
                  {saveMutation.isPending ? 'Сохранение...' : 'Сохранить товар'}
                </button>
              </div>
            </form>
          </div>
